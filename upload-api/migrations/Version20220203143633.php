 ...
 */
final class Version20220203143633 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE material DROP INDEX IDX_7CBE7595922726E9, ADD UNIQUE INDEX UNIQ_7CBE7595922726E9 (cover_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE material DROP INDEX UNIQ_7CBE7595922726E9, ADD INDEX IDX_7CBE7595922726E9 (cover_id)');
        $this->addSql('ALTER TABLE material DROP FOREIGN KEY FK_7CBE7595922726E9');
