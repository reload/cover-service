...
/**
 * Class CoverMoveProcessor.
 */
class CoverMoveProcessor implements Processor, TopicSubscriberInterface
{
    private $em;
    private $producer;
    private $statsLogger;
    ...
    /**
     * CoverMoveProcessor constructor.
     *
    ...
    public static function getSubscribedTopics()
    {
        return [
            'CoverMoveTopic' => [
                'processorName' => 'CoverMoveProcessor',
